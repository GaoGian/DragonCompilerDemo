...
public class SimpleJavaTest {
    ...
    public void testSimpleJava(){
        ...
        LexUtils.outputUniversalTreeEchart(new LexUtils.UniversalTreeNode(syntaxTree.getSyntaxTreeRoot(), SyntaxDirectedTest.getDirectTreeMatcher(), true), 300, 500);
